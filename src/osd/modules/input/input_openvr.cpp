...
{
    openvr_device *l_pDevice = module.devicelist()->create_device<openvr_device>(machine, "open vr controller", "vr_virtual_controller", module);
    l_pDevice->initItems();
}
...
//============================================================
openvr_device::openvr_device(running_machine &machine, const char *name, const char *id, input_module &module)
...
public:
    ...
    {
        openvr_device *l_pDevice = devicelist()->create_device<openvr_device>(machine, "open vr controller", "vr_virtual_controller", *this);
        l_pDevice->initItems();
    }
};
